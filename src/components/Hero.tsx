...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center px-4 py-20 overflow-hidden">
      ...
      <div className="absolute top-8 left-4 md:left-8 animate-fade-in z-10">
      ...
      <div className="max-w-4xl mx-auto text-center space-y-8 mt-32 md:mt-24 animate-slide-up z-10 relative">
